...
const CourseOverview = ({ isLoggedIn, setIsLoggedIn }) => {
  ...
  return (
    <div className="font-sans text-gray-800 ">
      ...
      <div className="w-full flex justify-center pt-2 pb-16 bg-white">
        <div className="bg-gray-50 text-center px-10 py-16 rounded-md shadow-md w-[90%] md:w-[70%]">
          <h2 className="text-4xl md:text-4xl font-bold text-orange-600 mb-8">
            Unlock Your Potential
          </h2>
          <p className="text-gray-700 mb-6 w-[80%] ml-[10%]">
            Join our expert-led course today and gain the skills you need to
            succeed. Start your journey towards excellence now!
          </p>
          <button
            className="bg-orange-600 hover:bg-orange-700 text-white font-semibold py-2 px-4 rounded cursor-pointer active:scale-90"
            onClick={() => {
