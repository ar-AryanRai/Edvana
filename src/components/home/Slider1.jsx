...
const Slider1 = ({ apiKey }) => {
  ...
  return (
    <div className="slider mt-6 w-[60%] ml-[20%] h-[65vh] rounded-lg flex justify-center relative overflow-hidden">
      <div
        className="w-[100%] h-[100%] bg-cover bg-center bg-no-repeat cursor-pointer"
        style={{
          backgroundImage: `url(${topCourses[i].snippet.thumbnails.high.url})`,
        }}
        onClick={handleOpenPlaylist}
      ></div>
      <div className="left flex items-center justify-center w-[4%] h-[100%] absolute -left-10 top-0 z-100">
        <div
      ...
      <div className="right flex items-center justify-center w-[4%] h-[100%] absolute -right-10 top-0 z-100">
        <div
          className="h-[40px] w-[40px] bg-[#E63600] text-3xl rounded-[50%] flex items-center bg-transparent justify-center cursor-pointer"
