...
const Form = () => {
  ...
  return (
    ...
    >
      ...
      <div className="forgetPswd cursor-pointer text-[#FF3D00] mt-2 text-sm">
        Forget your password?
      </div>

      <button
        type="submit"
        className="login-btn text-center bg-[#FF3D00] text-white py-2 px-4 mt-2 rounded-lg cursor-pointer active:scale-90"
      >
        Log In
      </button>
    </form>
