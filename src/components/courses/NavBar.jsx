    ...
    <div className="h-[8vh] flex items-center justify-between px-10 ">
      <div className="left flex h-[100%] pb-1">
        ...
        <div className="navs flex items-center text-sm gap-2 ml-10 h-[100%]">
          <div
            className="home flex items-center justify-center w-[80px] text-[#CBD5E1] hover:text-[#818CF8] h-[100%] cursor-pointer"
            onClick={(e) => handleNavigation(e)}
          >
            Home
          </div>
          <div
            className="courses flex items-center justify-center w-[80px] h-[100%] text-[#6366F1] hover:text-[#818CF8] font-semibold border-b-3 cursor-pointer"
            onClick={(e) => handleNavigation(e)}
          >
            Courses
          </div>
      ...
      <div className="right flex items-center gap-7">
        <div className="search text-lg cursor-pointer">
          <input
            ...
            className="bg-slate-600 text-white placeholder:text-slate-300 text-sm py-1 px-3 outline-none rounded-lg mr-2 w-[350px]"
          />
          <FontAwesomeIcon
            icon={faMagnifyingGlass}
            className="active:scale-90 text-gray-300"
