    ...
    <div className="w-[40%] h-[30vh] ml-[10%] mt-20">
      ...
      <div className="text-area mt-3 h-[70%]">
        <textarea
          ...
          className="border-1 px-6 py-3 border-gray-400 rounded-lg resize-x w-[100%]"
          rows="5"
      ...
      <div className="btns flex gap-8 px-4">
        <div
          className="save-notes px-4 py-1 font-semibold text-sm rounded-lg bg-green-500 text-white cursor-pointer active:scale-90"
        ...
        <div
          className="edit px-4 rounded-lg py-1 font-semibold text-white bg-[#E63600] text-sm cursor-pointer active:scale-90"
