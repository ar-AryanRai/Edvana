...
const VideoList = ({
  ...
  return (
    <div className="w-[38%] ml-10 mb-20 pt-8">
      ...
      <div className="border-2 rounded-lg px-4 py-2 h-[100vh] overflow-auto">
        {playlistData.map((ele, idx) => (
          <div className="video-det-container flex" key={`${idx}`}>
            ...
            <div
              className="video-det flex mb-3 shadow shadow-gray-400 w-[95%] rounded-lg overflow-hidden cursor-pointer hover:scale-[1.02] active:scale-95 transition-scale duration-100"
              onClick={() => {
                const videoIndex = idx;
                handleVideoChange(videoIndex);
              }}
            >
              <div className="left w-[26%] bg-cover bg-center">
                <img
