    ...
    <div className="h-[8vh] flex items-center justify-between px-10 ">
      <div className="left flex h-[100%] pb-1">
        <div className="logo flex items-center gap-2">
          ...
          <h1 className="text-2xl text-white font-bold">ElevateU</h1>
        </div>
      ...
      {isLoggedIn ? (
        <div className="right2 relative">
          ...
          <div className="hover-part absolute top-10 -right-8 px-3 py-1 rounded-lg text-sm text-white bg-slate-700 w-[8vw] hidden cursor-default active:scale-90 text-center z-100">
            <div>{userData.name}</div>
            <div
              className="logout bg-orange-400 px-2 py-1 mt-2 cursor-pointer rounded"
